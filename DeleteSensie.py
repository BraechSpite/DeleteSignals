...
import nest_asyncio
import asyncio
from aiohttp import web  # Import aiohttp to handle HTTP requests
import os

# Apply nest_asyncio to allow nested event loops
nest_asyncio.apply()

# Your API ID and Hash (replace with your actual values)
api_id = 22557209  # Replace with your API ID
api_hash = '2c2cc680074bcfa5e77f2773ff6e565b'  # Replace with your API Hash
phone_number = '+919956915970'  # Replace with your phone number

# Initialize the client with your user account credentials
...
async def main():
    await client.start(phone=phone_number)  # Authenticate your user bot
